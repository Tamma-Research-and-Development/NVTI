...
* @author 
**/
final class fetchStudentList extends teacherDetails
{
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'GET') {
            ...
            if (!empty($_GET['id']) && empty($_GET['searchPhrase'])) {
                ...
                $this->fetch_student_list_query = $this->selectFromTBL ( 
                    ...
                    'participants', 
                    [
                        " `id` = '$this->record_id' ", " AND `deleted` = '0' ",
            ...
            if ( $this->fetch_student_list_query['status'] == false ) {
                $this->output(
                    false, 500, 
                    $this->fetch_student_list_query['SQL_snapshot']. ' ==== Student list retrieval failed', 
...
// 
$fetchStudentList = new fetchStudentList;
$fetchStudentList->main();
?>